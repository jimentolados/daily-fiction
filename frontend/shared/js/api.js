...
const AuthAPI = {
  ...
  login:    (identifier, pass) => apiFetch('/auth/login/', { method: 'POST', body: JSON.stringify({ identifier, password: pass }) }),
  ...
  changeEmail:     (data)  => apiFetch('/auth/me/email/',    { method: 'POST', body: JSON.stringify(data) }),
